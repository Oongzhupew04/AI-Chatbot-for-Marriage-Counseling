            ...
            <div className={styles['settings-grid']}>
                <div className={styles['setting-card']}>
                    <div className={styles['card-title']}>
                        <i className={`fas fa-bell ${styles['icon-bell']}`}></i> Notifications
                    </div>

                    <div className={styles['setting-row']}>
                        <div className={styles['setting-info']}>
                            <h4>Push Notifications</h4>
                            <p>Receive alerts when a high risk alert is received</p>
                        </div>
                ...
                <div className={styles['setting-card']}>
                    <div className={styles['card-title']}>
                        <i className={`fas fa-paint-brush ${styles['icon-paint']}`}></i> Appearance
                    </div>
